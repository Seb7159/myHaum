...
file_put_contents("ips.txt", "mobile " . date('Y m d   H i s') . "                  " . $ip . "   " . $details->country . "\n" . "   " . $details->region . "   " . $details->city . "   " . $details->hostname . "   " . $details->loc . "   " . $details->org . "\n", FILE_APPEND); 
...
while($row=mysql_fetch_array($result)){
	...
	echo $row[1];
	echo "</span>&deg;C &nbsp;&nbsp;&nbsp;  </font><hr id='tempHr' width=50% style='border: 1px solid rgba(255,255,255,0.8);'><font id='humNot' size=2 style='line-height: 4px; color: rgba(255,255,255,0.8);'>Humidity: <span id='humNotif'>"; 
	echo $row[2];
